 ...
 * @author Rosemoe
 */
class TsTheme(private val tsQuery: TSQueryAdapter) {
 ...
 */
class TsThemeBuilder(tsQuery: TSQueryAdapter) {
 ...
 */
fun tsTheme(tsQuery: TSQueryAdapter, description: TsThemeBuilder.() -> Unit) =
