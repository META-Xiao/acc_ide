...
open class TsLanguageSpec(
    ...
    /**
     * The actual [TSQueryAdapter] object
     */
    val tsQuery = TSQueryAdapter.create(language, querySource)
    ...
    val blocksQuery = TSQueryAdapter.create(language, codeBlocksScmSource)

    val bracketsQuery = TSQueryAdapter.create(language, bracketsScmSource)
