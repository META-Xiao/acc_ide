...
import io.github.rosemoe.sora.editor.ts.adapter.TSInputEditAdapter
import io.github.rosemoe.sora.editor.ts.adapter.TSParserAdapter
import io.github.rosemoe.sora.editor.ts.adapter.TSQueryCursorAdapter
import io.github.rosemoe.sora.editor.ts.adapter.TSTreeAdapter
import io.github.rosemoe.sora.editor.ts.adapter.UTF16StringAdapter
import io.github.rosemoe.sora.editor.ts.adapter.UTF16StringFactoryAdapter
...
open class TsAnalyzeManager(val languageSpec: TsLanguageSpec, var theme: TsTheme) :
    ...
    inner class TsLooperThread : Thread() {
        ...
        val localText: UTF16StringAdapter = UTF16StringFactoryAdapter.newString()
        private val parser = TSParserAdapter.create().also {
            it.language = languageSpec.language
        }
        var tree: TSTreeAdapter? = null
        ...
        fun updateCodeBlocks() {
            ...
            TSQueryCursorAdapter.create().use {
    ...
    data class TextModification(
        val start: Int,
        val end: Int,
        val tsEdition: TSInputEditAdapter,
        /**
         * null for deletion
         */
