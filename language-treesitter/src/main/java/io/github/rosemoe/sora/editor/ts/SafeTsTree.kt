...
import io.github.rosemoe.sora.editor.ts.adapter.TSLanguageInterface
import io.github.rosemoe.sora.editor.ts.adapter.TSNodeAdapter
import io.github.rosemoe.sora.editor.ts.adapter.TSTreeAdapter
import java.util.concurrent.locks.ReentrantLock

/**
 * Safe accessor for [TSTreeAdapter] instances. single [TSTreeAdapter] is not thread-safe. This class adds lock
 * to make thread-safe access to the tree.
 *
 * @author Rosemoe
 */
class SafeTsTree(private val tree: TSTreeAdapter) : AutoCloseable {
    ...
    inner class TreeAccessor(internal var accessible: Boolean = true) {
         ...
         *
         * @see TSTreeAdapter.rootNode
         */
        val rootNode: TSNodeAdapter
            get() {
                checkAccess()
         ...
         *
         * @see TSTreeAdapter.language
         */
        val language: TSLanguageInterface?
            get() {
                checkAccess()
