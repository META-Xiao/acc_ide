...
public class UnicodeInputTest extends TerminalTestCase {
	...
	public void testIllFormedUtf8SuccessorByteNotConsumed() throws Exception {
		// The Unicode Standard Version 6.2 ‚Ä?Core Specification (http://www.unicode.org/versions/Unicode6.2.0/ch03.pdf):
	...
	public void testCombiningCharacterInLastColumn() throws Exception {
		withTerminalSized(3, 2).enterString("  a\u0302").assertLinesAre("  a\u0302", "   ");
		withTerminalSized(3, 2).enterString("  aÃÄÃ≤").assertLinesAre("  aÃÄÃ≤", "   ");
		withTerminalSized(3, 2).enterString("AaÃÄÃ≤F").assertLinesAre("AaÃÄÃ≤F", "   ");
	}

	public void testWideCharacterInLastColumn() throws Exception {
		withTerminalSized(3, 2).enterString("  Êûù\u0302").assertLinesAre("   ", "Êûù\u0302 ");

		withTerminalSized(3, 2).enterString(" Êû?).assertLinesAre(" Êû?, "   ").assertCursorAt(0, 2);
		enterString("a").assertLinesAre(" Êû?, "a  ");
	}

	public void testWideCharacterDeletion() throws Exception {
		// CSI Ps D Cursor Backward Ps Times
		withTerminalSized(3, 2).enterString("Êûù\033[Da").assertLinesAre(" a ", "   ");
		withTerminalSized(3, 2).enterString("Êûù\033[2Da").assertLinesAre("a  ", "   ");
		withTerminalSized(3, 2).enterString("Êûù\033[2DÊû?).assertLinesAre("Êû?", "   ");
		withTerminalSized(3, 2).enterString("Êûù\033[1DÊû?).assertLinesAre(" Êû?, "   ");
		withTerminalSized(5, 2).enterString(" Êû?\033[Da").assertLinesAre(" Êûùa ", "     ");
		withTerminalSized(5, 2).enterString("a \033[D\u0302").assertLinesAre("a\u0302    ", "     ");
		withTerminalSized(5, 2).enterString("Êû?\033[D\u0302").assertLinesAre("Êûù\u0302   ", "     ");
		enterString("Z").assertLinesAre("Êûù\u0302Z  ", "     ");
		enterString("\033[D ").assertLinesAre("Êûù\u0302   ", "     ");
	...
	public void testWideCharOverwriting() {
		withTerminalSized(3, 2).enterString("abc\033[3DÊû?).assertLinesAre("Êûùc", "   ");
	}
	...
	public void testWideCharacterWithoutWrapping() throws Exception {
		...
		withTerminalSized(3, 3).enterString("\033[?7l").enterString("ÊûùÊûùÊû?).assertLinesAre("Êû?", "   ", "   ");
		enterString("aÊû?).assertLinesAre("Êûùa", "   ", "   ");
	}
