...
import com.acc_ide.app.BaseIDEActivity;
import com.acc_ide.termux.R;
import com.acc_ide.termux.app.activities.HelpActivity;
import com.acc_ide.termux.app.api.file.FileReceiverActivity;
import com.acc_ide.termux.app.terminal.TermuxActivityRootView;
import com.acc_ide.termux.app.terminal.TermuxSessionsListViewController;
import com.acc_ide.termux.app.terminal.TermuxTerminalSessionActivityClient;
import com.acc_ide.termux.app.terminal.TermuxTerminalViewClient;
import com.acc_ide.termux.app.terminal.io.TerminalToolbarViewPager;
import com.acc_ide.termux.app.terminal.io.TermuxTerminalExtraKeys;
import com.acc_ide.termux.shared.activities.ReportActivity;
import com.acc_ide.termux.shared.activity.ActivityUtils;
import com.acc_ide.termux.shared.activity.media.AppCompatActivityUtils;
import com.acc_ide.termux.shared.android.PermissionUtils;
import com.acc_ide.termux.shared.data.DataUtils;
import com.acc_ide.termux.shared.data.IntentUtils;
import com.acc_ide.termux.shared.logger.Logger;
import com.acc_ide.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_ACTIVITY;
import com.acc_ide.termux.shared.termux.TermuxUtils;
import com.acc_ide.termux.shared.termux.crash.TermuxCrashUtils;
import com.acc_ide.termux.shared.termux.extrakeys.ExtraKeysView;
import com.acc_ide.termux.shared.termux.interact.TextInputDialogUtils;
import com.acc_ide.termux.shared.termux.settings.preferences.TermuxAppSharedPreferences;
import com.acc_ide.termux.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.acc_ide.termux.shared.termux.shell.command.runner.terminal.TermuxSession;
import com.acc_ide.termux.shared.termux.theme.TermuxThemeUtils;
import com.acc_ide.termux.shared.theme.NightMode;
import com.acc_ide.termux.shared.view.ViewUtils;
import com.acc_ide.termux.terminal.TerminalSession;
import com.acc_ide.termux.terminal.TerminalSessionClient;
import com.acc_ide.termux.view.TerminalView;
import com.acc_ide.termux.view.TerminalViewClient;
