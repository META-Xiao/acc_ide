package com.acc_ide.termux.shared.termux;
...
import com.acc_ide.termux.shared.android.PackageUtils;
...
import com.acc_ide.termux.shared.reflection.ReflectionUtils;
...
public class TermuxUtils {
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.acc_ide.termux.shared.R.raw.apt_info_script);
        try {
