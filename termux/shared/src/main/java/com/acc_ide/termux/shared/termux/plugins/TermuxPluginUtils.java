package com.acc_ide.termux.shared.termux.plugins;
...
import com.acc_ide.termux.shared.R;
import com.acc_ide.termux.shared.activities.ReportActivity;
import com.acc_ide.termux.shared.file.FileUtils;
import com.acc_ide.termux.shared.termux.file.TermuxFileUtils;
import com.acc_ide.termux.shared.shell.command.result.ResultConfig;
import com.acc_ide.termux.shared.shell.command.result.ResultData;
import com.acc_ide.termux.shared.errors.Errno;
import com.acc_ide.termux.shared.errors.Error;
import com.acc_ide.termux.shared.notification.NotificationUtils;
import com.acc_ide.termux.shared.termux.models.UserAction;
import com.acc_ide.termux.shared.termux.notification.TermuxNotificationUtils;
import com.acc_ide.termux.shared.shell.command.result.ResultSender;
import com.acc_ide.termux.shared.shell.ShellUtils;
import com.acc_ide.termux.shared.android.AndroidUtils;
import com.acc_ide.termux.shared.termux.TermuxConstants;
import com.acc_ide.termux.shared.termux.TermuxConstants.TERMUX_APP.TERMUX_SERVICE;
...
import com.acc_ide.termux.shared.models.ReportInfo;
import com.acc_ide.termux.shared.termux.settings.properties.TermuxAppSharedProperties;
import com.acc_ide.termux.shared.shell.command.ExecutionCommand;
import com.acc_ide.termux.shared.data.DataUtils;
import com.acc_ide.termux.shared.markdown.MarkdownUtils;
